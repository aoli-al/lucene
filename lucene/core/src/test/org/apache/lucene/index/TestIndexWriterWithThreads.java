...
public class TestIndexWriterWithThreads extends LuceneTestCase {
    ...
    public void testIOExceptionDuringWriteSegmentWithThreadsOnlyOnceReplay() throws Exception {
        FrayInTestLauncher.INSTANCE.launchFrayReplay(() -> {
                ...
                }, "/Users/aoli/tmp/lucene-13552-replay/recording");
    }
    ...
    public void testIOExceptionDuringWriteSegmentWithThreadsOnlyOnce() throws Exception {
        ...
        }, new PCTScheduler(new ControlledRandom(), 15, 0), new ControlledRandom(), 10000, 64000, false,
                (configuration) -> {
            return null;
        });
    }
    ...
    public void runTest() {
        try {
            ...
            TestIndexWriterWithThreads test = new TestIndexWriterWithThreads();
            test.setUp();
            test._testMultipleThreadsFailure(new FailOnlyInWriteSegment(true));
            test.tearDown();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
